...
-- UUID defaults use gen_random_uuid() (Postgres 13+). Hosted Supabase
-- installs uuid-ossp in the extensions schema, so uuid_generate_v4 is
-- not on the migration role's search_path.
